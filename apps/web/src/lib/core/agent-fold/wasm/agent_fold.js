...
export class FoldStream {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        FoldStreamFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_foldstream_free(ptr, 0);
    }
    /**
     ...
     */
    extend(entries) {
        const ret = wasm.foldstream_extend(this.__wbg_ptr, entries);
        if (ret[2]) {
     ...
     */
    messages() {
        const ret = wasm.foldstream_messages(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    metadata() {
        const ret = wasm.foldstream_metadata(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    constructor(session_id) {
        ...
        const ret = wasm.foldstream_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        FoldStreamFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    push(entry) {
        const ret = wasm.foldstream_push(this.__wbg_ptr, entry);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    push_rows(entries) {
        const ret = wasm.foldstream_push_rows(this.__wbg_ptr, entries);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    snapshot(entries) {
        const ret = wasm.foldstream_snapshot(this.__wbg_ptr, entries);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
if (Symbol.dispose) FoldStream.prototype[Symbol.dispose] = FoldStream.prototype.free;
 ...
 * @returns {any}
 */
export function fold_session(session_id, entries) {
    const ptr0 = passStringToWasm0(session_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fold_session(ptr0, len0, entries);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./agent_fold_bg.js": import0,
    };
}

const FoldStreamFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_foldstream_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('agent_fold_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
