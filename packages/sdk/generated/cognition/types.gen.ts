...
export type SetPricingHandlerError =
  SetPricingHandlerErrors[keyof SetPricingHandlerErrors];
...
export type GetUsageHandlerError =
  GetUsageHandlerErrors[keyof GetUsageHandlerErrors];
...
export type GetUsageHandlerResponse =
  GetUsageHandlerResponses[keyof GetUsageHandlerResponses];
...
export type UpsertAiProjectionError =
  UpsertAiProjectionErrors[keyof UpsertAiProjectionErrors];
...
export type UpsertAiProjectionResponse =
  UpsertAiProjectionResponses[keyof UpsertAiProjectionResponses];
...
export type GetChatsForAttachmentHandlerError =
  GetChatsForAttachmentHandlerErrors[keyof GetChatsForAttachmentHandlerErrors];
...
export type GetChatsForAttachmentHandlerResponse =
  GetChatsForAttachmentHandlerResponses[keyof GetChatsForAttachmentHandlerResponses];
...
export type PermanentlyDeleteChatError =
  PermanentlyDeleteChatErrors[keyof PermanentlyDeleteChatErrors];
...
export type GetChatHistoryHandlerError =
  GetChatHistoryHandlerErrors[keyof GetChatHistoryHandlerErrors];
...
export type GetChatHistoryHandlerResponse =
  GetChatHistoryHandlerResponses[keyof GetChatHistoryHandlerResponses];
...
export type GetChatHistoryBatchMessagesHandlerError =
  GetChatHistoryBatchMessagesHandlerErrors[keyof GetChatHistoryBatchMessagesHandlerErrors];
...
export type GetChatHistoryBatchMessagesHandlerResponse =
  GetChatHistoryBatchMessagesHandlerResponses[keyof GetChatHistoryBatchMessagesHandlerResponses];
...
export type GetChatPermissionsError =
  GetChatPermissionsErrors[keyof GetChatPermissionsErrors];

export type GetChatPermissionsResponses = {
  200: GetChatPermissionsResponse;
};

export type GetChatPermissionsResponse2 =
  GetChatPermissionsResponses[keyof GetChatPermissionsResponses];
...
export type RevertDeleteChatError =
  RevertDeleteChatErrors[keyof RevertDeleteChatErrors];
...
export type RejectToolCallError =
  RejectToolCallErrors[keyof RejectToolCallErrors];
...
export type UpdateToolResponseError =
  UpdateToolResponseErrors[keyof UpdateToolResponseErrors];
...
export type UpdateToolCallError =
  UpdateToolCallErrors[keyof UpdateToolCallErrors];
...
export type GetCitationHandlerError =
  GetCitationHandlerErrors[keyof GetCitationHandlerErrors];
...
export type GetCitationHandlerResponse =
  GetCitationHandlerResponses[keyof GetCitationHandlerResponses];
...
export type RunImportHandlerResponse =
  RunImportHandlerResponses[keyof RunImportHandlerResponses];
...
export type DismissRunHandlerResponse =
  DismissRunHandlerResponses[keyof DismissRunHandlerResponses];
...
export type RetryGatherHandlerResponse =
  RetryGatherHandlerResponses[keyof RetryGatherHandlerResponses];
...
export type GetStateHandlerResponse =
  GetStateHandlerResponses[keyof GetStateHandlerResponses];
...
export type ListMcpServersError =
  ListMcpServersErrors[keyof ListMcpServersErrors];
...
export type AddMcpServerResponse =
  AddMcpServerResponses[keyof AddMcpServerResponses];
...
export type StartMcpAuthResponse =
  StartMcpAuthResponses[keyof StartMcpAuthResponses];
...
export type GetMemoryHandlerError =
  GetMemoryHandlerErrors[keyof GetMemoryHandlerErrors];
...
export type GetMemoryHandlerResponse =
  GetMemoryHandlerResponses[keyof GetMemoryHandlerResponses];
...
export type GetStateHandler2Response =
  GetStateHandler2Responses[keyof GetStateHandler2Responses];
...
export type CompleteHandlerResponse =
  CompleteHandlerResponses[keyof CompleteHandlerResponses];
...
export type BrowsePipedreamMcpCatalogError =
  BrowsePipedreamMcpCatalogErrors[keyof BrowsePipedreamMcpCatalogErrors];
...
export type BrowsePipedreamMcpCatalogResponse =
  BrowsePipedreamMcpCatalogResponses[keyof BrowsePipedreamMcpCatalogResponses];
...
export type CompletePipedreamMcpConnectionError =
  CompletePipedreamMcpConnectionErrors[keyof CompletePipedreamMcpConnectionErrors];
...
export type CompletePipedreamMcpConnectionResponse =
  CompletePipedreamMcpConnectionResponses[keyof CompletePipedreamMcpConnectionResponses];
...
export type DeletePipedreamMcpConnectionError =
  DeletePipedreamMcpConnectionErrors[keyof DeletePipedreamMcpConnectionErrors];
...
export type DeletePipedreamMcpConnectionResponse =
  DeletePipedreamMcpConnectionResponses[keyof DeletePipedreamMcpConnectionResponses];
...
export type ListPipedreamMcpConnectionsError =
  ListPipedreamMcpConnectionsErrors[keyof ListPipedreamMcpConnectionsErrors];
...
export type ListPipedreamMcpConnectionsResponse =
  ListPipedreamMcpConnectionsResponses[keyof ListPipedreamMcpConnectionsResponses];
...
export type UpdatePipedreamMcpConnectionError =
  UpdatePipedreamMcpConnectionErrors[keyof UpdatePipedreamMcpConnectionErrors];
...
export type UpdatePipedreamMcpConnectionResponse =
  UpdatePipedreamMcpConnectionResponses[keyof UpdatePipedreamMcpConnectionResponses];
...
export type CreatePipedreamMcpTokenError =
  CreatePipedreamMcpTokenErrors[keyof CreatePipedreamMcpTokenErrors];
...
export type CreatePipedreamMcpTokenResponse =
  CreatePipedreamMcpTokenResponses[keyof CreatePipedreamMcpTokenResponses];
...
export type GetBatchPreviewError =
  GetBatchPreviewErrors[keyof GetBatchPreviewErrors];

export type GetBatchPreviewResponses = {
  200: GetBatchPreviewResponse;
};

export type GetBatchPreviewResponse2 =
  GetBatchPreviewResponses[keyof GetBatchPreviewResponses];
...
export type SendChatMessageError =
  SendChatMessageErrors[keyof SendChatMessageErrors];
...
export type SendChatMessageResponse2 =
...
export type StopChatStreamError2 =
  StopChatStreamErrors[keyof StopChatStreamErrors];
...
export type StopChatStreamResponse2 =
  StopChatStreamResponses[keyof StopChatStreamResponses];
...
export type StructuredCompletionError2 =
  StructuredCompletionErrors[keyof StructuredCompletionErrors];
...
export type StructuredCompletionResponse2 =
  StructuredCompletionResponses[keyof StructuredCompletionResponses];
