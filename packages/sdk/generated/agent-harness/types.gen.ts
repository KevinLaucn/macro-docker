...
export type LoadAgentModelsHandlerResponse =
  LoadAgentModelsHandlerResponses[keyof LoadAgentModelsHandlerResponses];
...
export type GetAgentSandboxSizeError =
  GetAgentSandboxSizeErrors[keyof GetAgentSandboxSizeErrors];
...
export type GetAgentSandboxSizeResponse =
  GetAgentSandboxSizeResponses[keyof GetAgentSandboxSizeResponses];
...
export type PutAgentSandboxSizeError =
  PutAgentSandboxSizeErrors[keyof PutAgentSandboxSizeErrors];
...
export type PutAgentSandboxSizeResponse =
  PutAgentSandboxSizeResponses[keyof PutAgentSandboxSizeResponses];
...
export type CreateAgentSessionError =
  CreateAgentSessionErrors[keyof CreateAgentSessionErrors];

export type CreateAgentSessionResponses = {
  201: CreateAgentSessionResponse;
};

export type CreateAgentSessionResponse2 =
  CreateAgentSessionResponses[keyof CreateAgentSessionResponses];
...
export type PreviewAgentSessionsError =
  PreviewAgentSessionsErrors[keyof PreviewAgentSessionsErrors];

export type PreviewAgentSessionsResponses = {
  200: PreviewAgentSessionsResponse;
};

export type PreviewAgentSessionsResponse2 =
  PreviewAgentSessionsResponses[keyof PreviewAgentSessionsResponses];
...
export type DeleteAgentSessionError =
  DeleteAgentSessionErrors[keyof DeleteAgentSessionErrors];
...
export type GetAgentSessionError =
  GetAgentSessionErrors[keyof GetAgentSessionErrors];
...
export type GetAgentSessionResponse =
  GetAgentSessionResponses[keyof GetAgentSessionResponses];
...
export type ControlAgentSessionError =
  ControlAgentSessionErrors[keyof ControlAgentSessionErrors];
...
export type ControlAgentSessionResponse =
  ControlAgentSessionResponses[keyof ControlAgentSessionResponses];
...
export type GetAgentSessionLogError =
  GetAgentSessionLogErrors[keyof GetAgentSessionLogErrors];
...
export type GetAgentSessionLogResponse =
  GetAgentSessionLogResponses[keyof GetAgentSessionLogResponses];
...
export type RenameAgentSessionError =
  RenameAgentSessionErrors[keyof RenameAgentSessionErrors];
...
export type RenameAgentSessionResponse =
  RenameAgentSessionResponses[keyof RenameAgentSessionResponses];
...
export type GetAgentSessionQueueError =
  GetAgentSessionQueueErrors[keyof GetAgentSessionQueueErrors];
...
export type GetAgentSessionQueueResponse =
  GetAgentSessionQueueResponses[keyof GetAgentSessionQueueResponses];
...
export type RemoveQueuedActionError =
  RemoveQueuedActionErrors[keyof RemoveQueuedActionErrors];
...
export type RemoveQueuedActionResponse =
  RemoveQueuedActionResponses[keyof RemoveQueuedActionResponses];
...
export type EditQueuedActionError =
  EditQueuedActionErrors[keyof EditQueuedActionErrors];
...
export type EditQueuedActionResponse =
  EditQueuedActionResponses[keyof EditQueuedActionResponses];
...
export type PutAgentSessionSandboxSizeError =
  PutAgentSessionSandboxSizeErrors[keyof PutAgentSessionSandboxSizeErrors];
...
export type PutAgentSessionSandboxSizeResponse =
  PutAgentSessionSandboxSizeResponses[keyof PutAgentSessionSandboxSizeResponses];
