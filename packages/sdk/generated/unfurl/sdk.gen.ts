...
import type {
  GetUnfurlBulkData,
  GetUnfurlBulkErrors,
  GetUnfurlBulkResponses,
  GetUnfurlData,
  GetUnfurlErrors,
  GetUnfurlResponses,
  ProxyRequestHandlerData,
} from './types.gen';
...
export class Sdk extends HeyApiClient {
  ...
  public proxyRequestHandler<ThrowOnError extends boolean = false>(
    options: Options<ProxyRequestHandlerData, ThrowOnError>
   ...
   */
  public getUnfurl<ThrowOnError extends boolean = false>(
    options: Options<GetUnfurlData, ThrowOnError>
  ): RequestResult<GetUnfurlResponses, GetUnfurlErrors, ThrowOnError> {
  ...
  public getUnfurlBulk<ThrowOnError extends boolean = false>(
    options: Options<GetUnfurlBulkData, ThrowOnError>
  ): RequestResult<GetUnfurlBulkResponses, GetUnfurlBulkErrors, ThrowOnError> {
