...
export type DeleteCursorApiKeyError =
  DeleteCursorApiKeyErrors[keyof DeleteCursorApiKeyErrors];
...
export type DeleteCursorApiKeyResponse =
  DeleteCursorApiKeyResponses[keyof DeleteCursorApiKeyResponses];
...
export type GetCursorApiKeyError =
  GetCursorApiKeyErrors[keyof GetCursorApiKeyErrors];
...
export type GetCursorApiKeyResponse =
  GetCursorApiKeyResponses[keyof GetCursorApiKeyResponses];
...
export type PutCursorApiKeyError =
  PutCursorApiKeyErrors[keyof PutCursorApiKeyErrors];
...
export type PutCursorApiKeyResponse =
  PutCursorApiKeyResponses[keyof PutCursorApiKeyResponses];
...
export type PutCursorDefaultModelError =
  PutCursorDefaultModelErrors[keyof PutCursorDefaultModelErrors];
...
export type PutCursorDefaultModelResponse =
  PutCursorDefaultModelResponses[keyof PutCursorDefaultModelResponses];
...
export type ListCursorModelsError =
  ListCursorModelsErrors[keyof ListCursorModelsErrors];
...
export type ListCursorModelsResponse =
  ListCursorModelsResponses[keyof ListCursorModelsResponses];
...
export type VerifyFusionauthUserEmailError =
  VerifyFusionauthUserEmailErrors[keyof VerifyFusionauthUserEmailErrors];
...
export type VerifyFusionauthUserEmailResponse =
  VerifyFusionauthUserEmailResponses[keyof VerifyFusionauthUserEmailResponses];
...
export type ResendFusionauthVerifyUserEmailError =
  ResendFusionauthVerifyUserEmailErrors[keyof ResendFusionauthVerifyUserEmailErrors];
...
export type ResendFusionauthVerifyUserEmailResponse =
  ResendFusionauthVerifyUserEmailResponses[keyof ResendFusionauthVerifyUserEmailResponses];
...
export type GenerateEmailLinkError =
  GenerateEmailLinkErrors[keyof GenerateEmailLinkErrors];
...
export type GenerateEmailLinkResponse =
  GenerateEmailLinkResponses[keyof GenerateEmailLinkResponses];
...
export type VerifyEmailLinkError =
  VerifyEmailLinkErrors[keyof VerifyEmailLinkErrors];
...
export type VerifyEmailLinkResponse =
  VerifyEmailLinkResponses[keyof VerifyEmailLinkResponses];
...
export type EnrichGithubPullRequestsError =
  EnrichGithubPullRequestsErrors[keyof EnrichGithubPullRequestsErrors];

export type EnrichGithubPullRequestsResponses = {
  200: EnrichGithubPullRequestsResponse;
};

export type EnrichGithubPullRequestsResponse2 =
  EnrichGithubPullRequestsResponses[keyof EnrichGithubPullRequestsResponses];
...
export type MacroApiTokenResponse2 =
  MacroApiTokenResponses[keyof MacroApiTokenResponses];
...
export type CreateInProgressLinkError =
  CreateInProgressLinkErrors[keyof CreateInProgressLinkErrors];

export type CreateInProgressLinkResponses = {
  200: CreateInProgressLinkResponse;
};

export type CreateInProgressLinkResponse2 =
  CreateInProgressLinkResponses[keyof CreateInProgressLinkResponses];
...
export type DeleteGithubLinkError =
  DeleteGithubLinkErrors[keyof DeleteGithubLinkErrors];
...
export type DeleteGithubLinkResponse =
  DeleteGithubLinkResponses[keyof DeleteGithubLinkResponses];
...
export type InitGithubLinkError =
  InitGithubLinkErrors[keyof InitGithubLinkErrors];

export type InitGithubLinkResponses = {
  200: InitGithubLinkResponse;
};

export type InitGithubLinkResponse2 =
  InitGithubLinkResponses[keyof InitGithubLinkResponses];
...
export type CheckGithubLinkStatusError =
  CheckGithubLinkStatusErrors[keyof CheckGithubLinkStatusErrors];
...
export type CheckGithubLinkStatusResponse =
  CheckGithubLinkStatusResponses[keyof CheckGithubLinkStatusResponses];
...
export type InitGmailLinkResponse2 =
  InitGmailLinkResponses[keyof InitGmailLinkResponses];
...
export type CheckGmailLinkStatusError =
  CheckGmailLinkStatusErrors[keyof CheckGmailLinkStatusErrors];
...
export type CheckGmailLinkStatusResponse =
  CheckGmailLinkStatusResponses[keyof CheckGmailLinkStatusResponses];
...
export type InitOutlookLinkError =
  InitOutlookLinkErrors[keyof InitOutlookLinkErrors];

export type InitOutlookLinkResponses = {
  200: InitOutlookLinkResponse;
};

export type InitOutlookLinkResponse2 =
  InitOutlookLinkResponses[keyof InitOutlookLinkResponses];
...
export type PasswordlessLoginError =
  PasswordlessLoginErrors[keyof PasswordlessLoginErrors];
...
export type PasswordlessLoginResponse =
  PasswordlessLoginResponses[keyof PasswordlessLoginResponses];
...
export type CreateMergeRequestError =
  CreateMergeRequestErrors[keyof CreateMergeRequestErrors];
...
export type CreateMergeRequestResponse =
  CreateMergeRequestResponses[keyof CreateMergeRequestResponses];
...
export type VerifyMergeRequestError =
  VerifyMergeRequestErrors[keyof VerifyMergeRequestErrors];
...
export type VerifyMergeRequestResponse =
  VerifyMergeRequestResponses[keyof VerifyMergeRequestResponses];
...
export type SendMobileWelcomeEmailError =
  SendMobileWelcomeEmailErrors[keyof SendMobileWelcomeEmailErrors];

export type SendMobileWelcomeEmailResponses = {
  200: SendMobileWelcomeEmailResponse;
};

export type SendMobileWelcomeEmailResponse2 =
  SendMobileWelcomeEmailResponses[keyof SendMobileWelcomeEmailResponses];
...
export type PasswordlessCallbackError =
  PasswordlessCallbackErrors[keyof PasswordlessCallbackErrors];
...
export type PasswordlessCallbackResponse =
  PasswordlessCallbackResponses[keyof PasswordlessCallbackResponses];
...
export type GetReferralCodeError =
  GetReferralCodeErrors[keyof GetReferralCodeErrors];
...
export type GetReferralCodeResponse =
  GetReferralCodeResponses[keyof GetReferralCodeResponses];
...
export type SendReferralCodeError =
  SendReferralCodeErrors[keyof SendReferralCodeErrors];
...
export type SendReferralCodeResponse =
  SendReferralCodeResponses[keyof SendReferralCodeResponses];
...
export type SessionCreationError =
  SessionCreationErrors[keyof SessionCreationErrors];
...
export type SessionCreationResponse =
  SessionCreationResponses[keyof SessionCreationResponses];
...
export type SessionLoginResponse =
  SessionLoginResponses[keyof SessionLoginResponses];
...
export type ToggleTeamAutoJoinDomainError =
  ToggleTeamAutoJoinDomainErrors[keyof ToggleTeamAutoJoinDomainErrors];
...
export type ToggleTeamAutoJoinDomainResponse =
  ToggleTeamAutoJoinDomainResponses[keyof ToggleTeamAutoJoinDomainResponses];
...
export type PatchTeamCrmSettingsError =
  PatchTeamCrmSettingsErrors[keyof PatchTeamCrmSettingsErrors];

export type PatchTeamCrmSettingsResponses = {
  200: PatchTeamCrmSettingsResponse;
};

export type PatchTeamCrmSettingsResponse2 =
  PatchTeamCrmSettingsResponses[keyof PatchTeamCrmSettingsResponses];
...
export type DeleteTeamInviteHandlerError =
  DeleteTeamInviteHandlerErrors[keyof DeleteTeamInviteHandlerErrors];
...
export type GetTeamInvitesError =
  GetTeamInvitesErrors[keyof GetTeamInvitesErrors];
...
export type GetTeamInvitesResponse =
  GetTeamInvitesResponses[keyof GetTeamInvitesResponses];
...
export type RejectInvitationError =
  RejectInvitationErrors[keyof RejectInvitationErrors];
...
export type ToggleTeamNonAdminInvitesError =
  ToggleTeamNonAdminInvitesErrors[keyof ToggleTeamNonAdminInvitesErrors];
...
export type ToggleTeamNonAdminInvitesResponse =
  ToggleTeamNonAdminInvitesResponses[keyof ToggleTeamNonAdminInvitesResponses];
...
export type RemoveUserFromTeamError =
  RemoveUserFromTeamErrors[keyof RemoveUserFromTeamErrors];
...
export type GetUserTeamsResponse =
  GetUserTeamsResponses[keyof GetUserTeamsResponses];
...
export type GetUserInvitesError =
  GetUserInvitesErrors[keyof GetUserInvitesErrors];
...
export type GetUserInvitesResponse =
  GetUserInvitesResponses[keyof GetUserInvitesResponses];
...
export type GetUserNamesResponse =
  GetUserNamesResponses[keyof GetUserNamesResponses];
...
export type GetUserNamesWithEmailError =
  GetUserNamesWithEmailErrors[keyof GetUserNamesWithEmailErrors];
...
export type GetUserNamesWithEmailResponse =
  GetUserNamesWithEmailResponses[keyof GetUserNamesWithEmailResponses];
...
export type PatchUserGroupError =
  PatchUserGroupErrors[keyof PatchUserGroupErrors];
...
export type PatchUserGroupResponse =
  PatchUserGroupResponses[keyof PatchUserGroupResponses];
...
export type GetLegacyUserPermissionsError =
  GetLegacyUserPermissionsErrors[keyof GetLegacyUserPermissionsErrors];

export type GetLegacyUserPermissionsResponses = {
  200: GetLegacyUserPermissionsResponse;
};

export type GetLegacyUserPermissionsResponse2 =
  GetLegacyUserPermissionsResponses[keyof GetLegacyUserPermissionsResponses];
...
export type GetUserLinkExistsError =
  GetUserLinkExistsErrors[keyof GetUserLinkExistsErrors];
...
export type GetUserLinkExistsResponse =
  GetUserLinkExistsResponses[keyof GetUserLinkExistsResponses];
...
export type GetUserNameResponse =
  GetUserNameResponses[keyof GetUserNameResponses];
...
export type PutUserNameResponse =
  PutUserNameResponses[keyof PutUserNameResponses];
...
export type PatchUserOnboardingError =
  PatchUserOnboardingErrors[keyof PatchUserOnboardingErrors];
...
export type PatchUserOnboardingResponse =
  PatchUserOnboardingResponses[keyof PatchUserOnboardingResponses];
...
export type GetUserOrganizationError =
  GetUserOrganizationErrors[keyof GetUserOrganizationErrors];
...
export type GetUserOrganizationResponse =
  GetUserOrganizationResponses[keyof GetUserOrganizationResponses];
...
export type PutProfilePictureError =
  PutProfilePictureErrors[keyof PutProfilePictureErrors];
...
export type PutProfilePictureResponse =
  PutProfilePictureResponses[keyof PutProfilePictureResponses];
...
export type PostProfilePicturesError =
  PostProfilePicturesErrors[keyof PostProfilePicturesErrors];
...
export type PostProfilePicturesResponse =
  PostProfilePicturesResponses[keyof PostProfilePicturesResponses];
...
export type GetUserQuotaResponse =
  GetUserQuotaResponses[keyof GetUserQuotaResponses];
...
export type CreateCheckoutSessionV2Error =
  CreateCheckoutSessionV2Errors[keyof CreateCheckoutSessionV2Errors];
...
export type CreateCheckoutSessionV2Response =
  CreateCheckoutSessionV2Responses[keyof CreateCheckoutSessionV2Responses];
...
export type CreatePortalSessionError =
  CreatePortalSessionErrors[keyof CreatePortalSessionErrors];
...
export type CreatePortalSessionResponse =
  CreatePortalSessionResponses[keyof CreatePortalSessionResponses];
...
export type PatchUserTutorialError =
  PatchUserTutorialErrors[keyof PatchUserTutorialErrors];
...
export type PatchUserTutorialResponse =
  PatchUserTutorialResponses[keyof PatchUserTutorialResponses];
