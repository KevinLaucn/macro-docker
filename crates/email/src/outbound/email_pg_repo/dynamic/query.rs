    ...
    qb.build()
        ...
        .try_map(|row| {
            Ok(ThreadPreviewCursorDbRow {
                ...
                follow_up_completed_at: row.try_get("follow_up_completed_at")?,
                latest_inbound_message_ts: row.try_get("latest_inbound_message_ts")?,
                latest_outbound_message_ts: row.try_get("latest_outbound_message_ts")?,
